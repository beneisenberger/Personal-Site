  ...
  individual: Section[] = [
    {
      ...
      desc:
        "Obviously, a good first introduction to some of my web development style should come from my personal website, which you're looking at right now! This website is built with Angular 8, and also uses both Bootstrap and Angular Material for design. The blog is built as well, using Firebase as a host for the posts and Google to authenticate the login (to post to the blog).",
    ...
    // }
    {
      ...
      desc:
        "For our final project of the Midland Code Academy, my seven classmates and I reworked some code of the previous Code Adememy cohort, and combied two of the projects they did into one. For the Quiz Whip (quiz-making and taking app) portion of the site, the code is essentially a re-write. I was the client lead or 'product manager' for this project, and also helped to design the site and with most of the logic in the quiz display and how the results are shown on the dashboard. We are using Angular to build the project, and the backend is handled with Google Firebase/Firestore.",
